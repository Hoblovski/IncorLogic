...
Lemma t_update_eq : forall (A : Type) (m : total_map A) x v,
  (x !-> v ; m) x = v.
Proof.
  intros. unfold t_update. rewrite eqb_refl. auto. Qed.
...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
  ...
  (x1 !-> v ; m) x2 = m x2.
Proof.
  intros. unfold t_update. rewrite <-eqb_neq in H. rewrite H. auto. Qed.
...
Proof.
  ...
  - unfold t_update. rewrite Heq. reflexivity. Qed.
...
Proof.
  ...
  destruct (eqb x x0) eqn:Heq.
  - apply eqb_eq in Heq. subst. auto.
  - auto. Qed.
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
  ...
  (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros. apply functional_extensionality. unfold t_update. intros.
  destruct (eqb_spec x1 x); subst.
  { apply eqb_neq in H. rewrite H. auto. }
  destruct (eqb_spec x2 x); subst; auto. Qed.
